...
import 'package:reactive_components/src/infrastructure/reactive_components/sinks.dart';
import 'package:reactive_components/src/infrastructure/reactive_components/typedefs.dart';
...
class ResourceDisposer {
  ...
  Future<void>? _dispose() => _doDispose != null
      ...
      ? Future.wait<dynamic>([_doDispose!(), _disposePrivateResource() as Future<void>])
