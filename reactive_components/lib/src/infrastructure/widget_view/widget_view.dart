...
// Please let me know if I am wrong on this, Iâ€™m new to flutter and design
...
// @bob â€“ In this case the State is pretty much playing dual roles of controller
...
// Most often itâ€™s a mix of the two in production. You will have some local state
// that can be thought of as the â local model for that view, and then some
